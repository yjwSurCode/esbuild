...
const createBuild = () => {
    ...
    Object.keys(formats).forEach((key) => {
        ...
        build({
            entryPoints: [path.resolve(__dirname, './src/index.js')], // 入口文件 //path C:\material\Rollup+Esbuild\esbuil\package\src\index.js
            outfile: path.resolve(__dirname, './dist', fileName), //path C:\material\Rollup+Esbuild\esbuil\package\dist\index.js path C:\material\Rollup+Esbuild\esbuildDebug\dist\index.mjs
